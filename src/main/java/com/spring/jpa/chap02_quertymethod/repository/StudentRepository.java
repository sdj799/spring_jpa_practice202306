package com.spring.jpa.chap02_quertymethod.repository;

import com.spring.jpa.chap02_quertymethod.entity.Student;
...
public interface StudentRepository extends JpaRepository<Student, String> {
    ...
    List<Student> findByName(String name); //필드명으로 작성
